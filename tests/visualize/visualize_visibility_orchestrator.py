...
try:
    from app.services.agents.visibility_orchestrator.graph import get_visibility_orchestration_graph
except ImportError:
...
def main():
    print("Generating visibility orchestrator graph visualization...")
    try:
        ...
        output_file = "../../screenshots/visibility_orchestrator_graph.png"
