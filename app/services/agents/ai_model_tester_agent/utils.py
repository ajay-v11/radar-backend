...
def _query_batch_chunk(model: str, queries: List[str], target_region: str) -> List[str]:
    ...
    system_prompt = f"""You are a helpful AI assistant helping users in {target_region}.

Provide natural, helpful responses with specific brand names, product names, and company recommendations relevant to {target_region}.
Be specific - mention actual companies, services, and products by name that are available in {target_region}.

You will receive multiple queries. Answer each query separately.
Format your response as:

Query 1: [your answer with specific brand/company names]

Query 2: [your answer with specific brand/company names]
