...
from app.services.agents.ai_model_tester_agent.models import AIModelTesterState
...
def test_queries_batch(state: AIModelTesterState) -> AIModelTesterState:
    ...
    from app.services.agents.ai_model_tester_agent.utils import query_model_batch
