...
from app.services.agents.scorer_analyzer_agent.models import ScorerAnalyzerState
from app.services.agents.scorer_analyzer_agent.utils import (
...
def analyze_responses(state: ScorerAnalyzerState) -> ScorerAnalyzerState:
    ...
    try:
        from app.utils.competitor_matcher import get_competitor_matcher
