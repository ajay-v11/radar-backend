...
# Postgres Async Engine and Session
...
# Postgres Sync Engine (for migrations/scripts)
...
def test_connections() -> dict:
    """
    Test connections to ChromaDB, Redis, and Postgres.
...
async def init_db():
    ...
    async with async_engine.begin() as conn:
        # await conn.run_sync(SQLModel.metadata.drop_all) # Dangerous!
        await conn.run_sync(SQLModel.metadata.create_all)
    logger.info("Initialized Postgres database tables")
